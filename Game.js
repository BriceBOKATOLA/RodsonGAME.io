...
Swal.fire('Vous avez gagné la bataille! 🎉');
...
var box = document.createElement('div');
  ...
  box.innerHTML = 'Vous avez gagné! 🎉';
  document.getElementById('box').appendChild(box);
  
writeToLog(LOG_EVENT_GAME_OVER, 'PLAYER WON', currentMonsterHealth, currentPlayerHealth);}
//if hero lose battle 
else if (currentPlayerHealth <= 0 && currentMonsterHealth > 0){
Swal.fire('Vous perdez! ☠️');
navigator.vibrate(10);
//super attack & heal reset 0
count = 0;
var tbtn=document.getElementById('heal-btn');
...
var box = document.createElement('div');
  box.classList.add('myDiv');
  box.innerHTML = 'Vous perdez! ☠️';
  document.getElementById('box').appendChild(box);
  
writeToLog(LOG_EVENT_GAME_OVER, 'MONSTER WON', currentMonsterHealth, currentPlayerHealth);} 
//if tirage au sort 
else if (currentMonsterHealth <= 0 && currentPlayerHealth <= 0) {
      Swal.fire('tirage au sort! 🤕');
navigator.vibrate(10);
//super attack & heal reset 0
count = 0;
var tbtn=document.getElementById('heal-btn');
...
function healPlayerHandler() {
 ...
 Swal.fire({
   title: "<h5>Vous ne pouvez pas vous soigner au-delà de votre santé initiale maximale.</h5>",});
